...
async function startServer() {
    ...
    // 5. Connect GraphQL to Express at the /graphql route.
    //    Apollo Server 4 uses expressMiddleware instead of applyMiddleware.
    app.use('/graphql', expressMiddleware(server));

    // 6. The Port: Set the server to run on address 4000.
...
// 7. Run the Engine: Actually call the function to start everything.
